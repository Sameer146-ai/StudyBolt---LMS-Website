    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-corse-details-heading-large text-corse-details-heading-small font-semibold text-gray-800">
                              ...
                              <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                                ...
                                <div className="flex gap-2">
                                  {lecture.isPreviewFree && (
                                    <p className="text-blue-600 cursor-pointer" onClick={()=>setPlayerData(
                                      {
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              <img src={assets.time_left_clock_icon} alt="time left" className="w-3.5"/>
              ...
              <div className="pt-6">
                <p className="md:text-xl text-lg font-medium text-gray-800'">What's inside the course ?</p>
                <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500">
                  <li>Lifetime access with free updates.</li>
                  <li>Step-by-step , hands-on practice guidance.</li>
                  <li>Downloadable resources and sources code.</li>
